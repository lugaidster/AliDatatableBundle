...
namespace Lugaidster\DatatableBundle\Util\Formatter;
        ...
        foreach ($data as $row_index => $row) {
            ...
            foreach ($row as $column_index => $column) {
                ...
                if (array_key_exists($column_index, $this->_renderers)) {
                    ...
                    $params = isset($this->_renderers[$column_index]['params']) ? $this->_renderers[$column_index]['params']
                            : array ();
                } else {
                    $view = 'LugaidsterDatatableBundle:Renderers:_default.html.twig';
                }
